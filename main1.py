...
def print_banner():
    console.print(Panel.fit(
        ...
        "[cyan]Space LLM:[/cyan]    mistral:7b-instruct-q4_K_M\n"
        "[yellow]Defence LLM:[/yellow]  llama3.2:8b-instruct-q4_K_M\n"
        "[magenta]Quantum LLM:[/magenta]  qwen2.5:7b-instruct-q4_K_M\n"
        "[green]Commander:[/green]   qwen3:30b-a3b-instruct-q4_K_M\n"
        "[blue]Synthesis:[/blue]   gemma2:27b-instruct-q4_K_M\n"
